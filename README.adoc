// image:{img-mozilla}[Mozilla, link={mozilla-url}]


// :img-mozilla: https://img.shields.io/badge/Mozilla-0769AD?style=for-the-badge&logo=mozilla&logoColor=white
// :mozilla-url: https://www.mozilla.org/en-US/MPL/2.0/

= Documentation Cafe Default UI

https://documentation.cafe[Explore the site!] 


== Original README for the Antora Default UI project
// Settings:
:experimental:
:hide-uri-scheme:
// Project URLs:
